...
import com.alibaba.cloud.ai.dataagent.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    @Bean
    public JwtAuthenticationFilter jwtFilter(JwtUtil jwtUtil, TokenBlacklistService tokenBlacklistService) {
