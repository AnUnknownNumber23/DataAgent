...
public interface AgentMapper {
    ...
    @Select("""
            ...
            """)
    List<Agent> findAll(@Param("userId") Long userId);
    ...
    @Select("""
            ...
            """)
    Agent findById(@Param("id") Long id, @Param("userId") Long userId);
    ...
    @Select("""
            ...
            """)
    List<Agent> findByStatus(@Param("status") String status, @Param("userId") Long userId);
    ...
    @Select("""
            ...
            """)
    List<Agent> searchByKeyword(@Param("keyword") String keyword, @Param("userId") Long userId);
